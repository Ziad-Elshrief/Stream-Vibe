...
export default function Landing({ children }) {
  return (
    <div className="landing">
      <div
        className="relative before:absolute before:bottom-0 before:left-0 before:w-full before:h-3/4 before:z-2 before:bg-gradient-to-b  before:from-transparent  before:from-10%  before:to-black08  before:to-100%
after:absolute after:top-0 after:left-0 after:w-full after:h-3/4 after:z-2 after:bg-gradient-to-t  after:from-transparent  after:from-10%  after:to-black08  after:to-100%"
      >
        {children}
